...
if ($hassiteconfig) {
    ...
    $adminsetting = new admin_setting_configtext('res_categories_root_id', get_string('res_categories_root_id', 'local_kaltura'),
                       get_string('res_categories_root_id_desc', 'local_kaltura'), KALTURA_CATEGORIES_ROOT_ID, PARAM_INT);
    $adminsetting->plugin = KALTURA_PLUGIN_NAME;
    $settings->add($adminsetting);

    $adminsetting = new admin_setting_configtext('res_default_category', get_string('res_default_category', 'local_kaltura'),
                       get_string('res_default_category_desc', 'local_kaltura'), KALTURA_DEFAULT_CATEGORY, PARAM_TEXT);
    $adminsetting->plugin = KALTURA_PLUGIN_NAME;
    $settings->add($adminsetting);
