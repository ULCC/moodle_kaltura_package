...
$string['res_categories_root_id'] = 'KCW root category ID';
$string['res_categories_root_id_desc'] = 'Category Root ID when a user is uploading a video resource';
$string['res_default_category'] = 'Default KMC category';
$string['res_default_category_desc'] = 'KMC category specified when uploading a video resource';
