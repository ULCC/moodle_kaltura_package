...
M.local_kaltura.show_loading = function () {
	...
	YUI().use('yui2-container', function(Y) {
...
// Parameters extended to pass default tags and category by m.stubbs@mmu.ac.uk 2013-01-21
M.local_kaltura.video_assignment = function (Y, conversion_script, panel_markup,
	...
	YUI().use('yui2-container','node', 'json-parse','io-base',  function(Y) {
    ...
    function widget_panel_callback(e, widget_panel) {
		...
		// Added by m.stubbs@mmu.ac.uk 2013-01-21 to set tags and category
		kalturaScreenRecord.set_default_tags(default_tags);
		kalturaScreenRecord.set_default_category(default_category);
...
// Parameters extended by m.stubbs@mmu.ac.uk 2013-01-21 to pass tags and category
M.local_kaltura.video_resource = function (Y, conversion_script, 
    ...
    function widget_panel_callback(e, widget_panel) {
        ...
        if (Y.one("#id_media_method_0").get('checked')) {
		 ...
		 // Added by m.stubbs@mmu.ac.uk 2013-01-21 to set category and tags
            kalturaScreenRecord.set_default_category(default_category);
            kalturaScreenRecord.set_default_tags(default_tags);
...
M.local_kaltura.video_presentation = function (Y, conversion_script, 
	...
	// Added by m.stubbs@mmu.ac.uk 2013-01-14
	YUI().use('yui2-container', 'node', 'io', 'json-parse', function(Y) {
		var YAHOO = Y.YUI2;
