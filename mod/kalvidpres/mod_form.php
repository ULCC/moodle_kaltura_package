...
class mod_kalvidpres_mod_form extends moodleform_mod {
    ...
    function definition() {
        ...
        if (empty($this->current->entry_id)) {
			...
			// Extended the params passed to this function to add tags and category
			// m.stubbs@mmu.ac.uk 2013-01-21
                $PAGE->requires->js_init_call('M.local_kaltura.video_presentation',
									    ...
									    local_kaltura_get_tags('pres_uploader'),
									    local_kaltura_get_category()),
                                              true, $jsmodule);
            }
        }
