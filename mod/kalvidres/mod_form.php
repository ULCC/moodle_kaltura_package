...
class mod_kalvidres_mod_form extends moodleform_mod {
    ...
    function definition() {
		...
		// Code modified by m.stubbs@mmu.ac.uk 2013-01-21 to pass tags and category
            $PAGE->requires->js_init_call('M.local_kaltura.video_resource',
                                          array($conversion_script, $panel_markup, $kcw, $uiconf_id, $login_session, $partner_id, $progress_bar_markup, local_kaltura_get_tags('vidres'), local_kaltura_get_category()),
                                          true, $jsmodule);
        }
